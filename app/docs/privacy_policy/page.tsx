  ...
  return (
    <div className="prose prose-slate max-w-none">
      ...
      <p className="text-slate-700 mb-6 leading-relaxed">
        Ledgable (&quot;we&quot;, &quot;our&quot;, &quot;us&quot;) is committed to protecting your privacy. This
      ...
      <p className="text-slate-700 mb-3">We collect the following types of data when you use Ledgable:</p>
      ...
      <ul className="list-disc pl-6 mb-6 space-y-2 text-slate-700">
        <li>Create and manage your Ledgable account</li>
      ...
      <p className="text-slate-700 mb-6 leading-relaxed">
        By using Ledgable, you consent to the transfer of relevant data to these third-party providers for the purpose
      ...
      <p className="text-slate-700 mb-6 leading-relaxed">
        Ledgable does <strong className="text-slate-800">not use tracking cookies</strong> or third-party analytics. We
      ...
      <p className="text-slate-700 mb-6 leading-relaxed">
        Ledgable is <strong className="text-slate-800">not intended for users under the age of 18</strong>. We do not
