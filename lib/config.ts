...
const envSchema = z.object({
  ...
  RESEND_FROM_EMAIL: z.string().default("Ledgable <user@localhost>"),
...
const config = {
  app: {
    title: "Ledgable",
    description: "AI-powered accounting for Australian businesses — from $9/month",
    version: process.env.npm_package_version || "0.0.1",
    baseURL: env.BASE_URL || `http://localhost:${env.PORT || "7331"}`,
    supportEmail: "hello@ledgable.co",
  },
  upload: {
